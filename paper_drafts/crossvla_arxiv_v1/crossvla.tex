...
% Switch natbib to numeric citation style: [1], [2], [3] in text;
% references list ordered by first-cite appearance (matches unsrtnat).
...
\subsection{Cross-Paradigm Validation: \(\pi_{0.5}\) Surrogate Logp}\label{sec:cross-validation}
...
\begin{tabular}{lrrr}
\toprule
Suite & openpi paper SFT~\cite{openpi2025pi05} & \(\pi_{0.5}\) + LoRA + DPO (us) & \(\Delta\) \\
\midrule
Spatial & 98.8\% & \textbf{100.0\%} & \textbf{+1.2}\,pp \\
Object & 98.2\% & 98.0\% & \(-0.2\)\,pp (50-trial noise) \\
